...
void dial_items(Dial *d) {
    ...
    const DialItem items[] = {
        ...
        {l->motion, BONGO_CAT_MENU_NONE, 0xfffbbf24, 6, false,
            l->motion_count ? l->motion_count + 1 : 0},
        {l->expression, BONGO_CAT_MENU_NONE, 0xfff472b6, 7, false,
            l->expression_count ? l->expression_count + 1 : 0},
